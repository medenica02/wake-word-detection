...
Kod ROC-AUC krive vidimo da je AUC 0.996 što je izuzetno visok skor. Kriva odmah raste ka gornjem levom uglu što znači da model pri gotovo svakom pragu razlikuje klasu 0 od klase 1 sa minimalnim brojem lažnih alarma.
...
Rezultati su pokazali uspešnost i veoma dobre performanse oba pristupa u zadatku binarne klasifikacije, ali je jasno bila izražena razlika u korist MFCC reprezentacije podataka. Razlika u AP vrednosti od gotovo 14\% posebno je značajna, s obzirom na to da PR kriva predstavlja strožiji kriterijum evaluacije u uslovima nebalansiranog skupa podataka.
